...
私たちは大阪を拠点として、AI技術の普及と活用支援に取り組んでいます。本店住所は**大阪府大阪市浪速区湊町2丁目2番5号 2119号室**、**2025年4月16日**設立です。

社員は**2名**で、内堀代表とエンジニアのKoheiが、異なるバックグラウンドを活かし「**AIでエリート専用の武器を大衆の手に届ける**」というビジョンのもと事業を推進しています。`,
        options: [
          { id: 'company-basic', text: '会社名・所在地' },
...
**組織構成**:
• **内堀 善史** - 代表社員（社長）
• **Kohei** - エンジニア（関西最大級AIコミュニティ Finding AI 代表）

異なるバックグラウンドを持つ2人が、「**AIでエリート専用の武器を大衆の手に届ける**」というビジョンのもと事業を推進しています。`,
        options: [
...
**内堀 善史**（代表社員・社長）
20年間の零細企業経営で培った現場感覚と営業力が強み。生成AIとの出会いを通じて「アイデアさえあれば誰でも実現できる」と確信。

**Kohei**（エンジニア）
同志社大学理工学部出身。関西最大級のAIコミュニティ Finding AI 代表。動画生成をはじめとするAI技術に深い知見を持つ。`,
        options: [
          { id: 'uchibori-story', text: '内堀 善史（代表社員）' },
          { id: 'kohei', text: 'Kohei（エンジニア）' },
          { id: 'welcome', text: 'メインメニューに戻る' }
        ]
      },
...
**2024年末〜**: ChatGPT、Midjourney、Claude等を使い倒し、イラスト生成から文章執筆までAIで実現

**2025年2月**: エンジニアのKoheiが参画

**2025年4月**: AIナレッジワークス設立`,
        options: [
          { id: 'uchibori-vision', text: '内堀代表の想い・メッセージ' },
          { id: 'kohei', text: 'Koheiについて' },
          { id: 'staff', text: '社員紹介メニューに戻る' },
          { id: 'welcome', text: 'メインメニューに戻る' }
        ]
      },
...
同志社大学理工学部出身。関西最大級のAIコミュニティ Finding AI 代表を務め、動画生成をはじめとするAI技術に深い知見を持つエンジニアです。

Notion公式セミナーでは満員御礼＆アンケート1位を獲得するなど、AI活用の普及にも積極的に取り組んでいます。`,
        options: [
          { id: 'team-synergy', text: '2人のチーム力について' },
...
異なるバックグラウンドを持つ2人が、「**AIでエリート専用の武器を大衆の手に届ける**」というビジョンのもと結束。
